...
export default function FromText(){
    ...
    const onBlurPassword=()=>{
        ...
        if(pswd !== ''&& !pswd.match(/^[0-9 a-z A-Z]+$/)){
    ...
    return(
        <div className="mt-4 mx-auto p-3 rounder"
        style={{ width:'400px',background:'#cee'}}>
            <form>
                ...
                <div className="form-group mb-2">
                    ...
                    <input type="password" id="pswd" name="pswd" maxLength="10" className="form-control from-control-sm" ref={textPswd} onBlur={onBlurPassword}/>
                </div>
                <div className="form-group mb-2">
                    <label htmlFor="pswd2">ใส่รหัสผ่านซ้ำ</label>
                    <input type="p" id="pswd" name="pswd" maxLength="10" className="form-control from-control-sm" ref={textPswd2} onBlur={onBlurPassword2}/>
                </div>
                <div className="form-group mb-4">
                    <label htmlFor="memo">บันทึกช่วยจำ</label>
                    <textarea id="memo" name="memo" rows="2" maxLength="200" className="form-control from-control-sm">          
                    </textarea>
                </div>
                <div className="text-center">
                    <button type="btn btn-sm px-4 btn-primary">KO
                    </button>
                </div>
            </form>
        </div>
